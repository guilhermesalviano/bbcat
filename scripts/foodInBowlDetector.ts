...
async function createAndTrainModel(): Promise<tf.LayersModel> {
    ...
    // train the model with empty bowl and not empty bowl images
...
async function detectFoodBowlStatus(
    imagePath: string,
): Promise<BowlDetectionResult> {
    try {
...
async function main(): Promise<void> {
    ...
    try {
        const result: BowlDetectionResult = await detectFoodBowlStatus(
            imagePath,
        );
        console.log('\nResults:');
...
export { detectFoodBowlStatus, BowlDetectionResult };
